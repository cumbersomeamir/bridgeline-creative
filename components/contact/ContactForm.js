...
export default function ContactForm() {
  ...
  return (
    <section ref={ref} className="py-24 px-6 md:px-12 lg:px-24 bg-black">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="space-y-8">
              {/* Bookings */}
              <div className="p-8 border border-white/10 hover:border-rolling-red/30 transition-colors">
                <h3 
                ...
                <a 
                  ...
                  className="text-rolling-red hover:text-white transition-colors"
                >
              ...
              <div className="p-8 border border-white/10 hover:border-rolling-red/30 transition-colors">
                ...
                <p className="text-white/50 text-sm mb-4">
                  For brand partnerships, event IPs, creative collaborations, and international projects
                </p>
                <a 
                  href="mailto:info@bridgeline-creative.com"
                  className="text-rolling-red hover:text-white transition-colors"
              ...
              <div className="p-8 border border-white/10 hover:border-rolling-red/30 transition-colors">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-3 text-rolling-red hover:text-white transition-colors"
                >
            ...
            {/* Work with us */}
            <div className="p-8 bg-rolling-red/5 border border-rolling-red/30">
              <h3 
                className="text-xl text-rolling-red mb-3"
                style={{ fontFamily: 'var(--font-bebas)', letterSpacing: '0.05em' }}
              >
                WORK WITH US
              </h3>
              <p className="text-white/60 text-sm leading-relaxed">
                If you're an artist, promoter, brand, or creative collaborator who aligns with our vision and wants to build something meaningful, reach out.
              </p>
            </div>
          </motion.div>
        </div>
