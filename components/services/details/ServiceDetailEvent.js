...
// Design 2: Magazine editorial layout - ENHANCED
export default function ServiceDetailEvent({ service }) {
  ...
  const ipTypes = [
    {
      ...
      description: 'Recurring event formats that build community around specific sounds, aesthetics, or cultural movements. Designed for intimate venues with 200-800 capacity.',
      features: ['Community-focused', 'Curated lineup', 'Consistent branding', 'Local + international talent'],
      image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&q=80'
    },
    {
      title: 'Cinematic Experiences',
      description: 'Audiovisual spectacles combining music, art installations, and immersive environments. Focused on sensory storytelling and premium production.',
      features: ['Visual installations', 'Spatial design', 'Multi-sensory', 'Limited editions'],
      image: 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&q=80'
    },
    {
      title: 'Cross-Continental Formats',
      description: 'Event IPs designed for rollout across India and UK markets, maintaining consistent identity while adapting to local contexts.',
    ...
    },
    {
      ...
      description: 'Signature events owned and operated by artists, creating platforms for their creative vision beyond DJ sets.',
  ...
  const creationProcess = [
    { phase: 'CONCEPT', title: 'Narrative Development', desc: 'Defining the story, cultural context, and emotional journey of the IP' },
    { phase: 'IDENTITY', title: 'Brand Architecture', desc: 'Creating visual systems, naming, and positioning strategy' },
    { phase: 'DESIGN', title: 'Experience Blueprint', desc: 'Stage design, spatial layout, lighting direction, and flow planning' },
    { phase: 'ASSETS', title: 'Creative Production', desc: 'Posters, motion graphics, social content, and collateral' },
    { phase: 'LAUNCH', title: 'Market Activation', desc: 'Rollout strategy, talent booking, and promotional campaign' },
    { phase: 'SCALE', title: 'Growth Planning', desc: 'Multi-city expansion, sponsorship integration, and iteration' },
  ]
    ...
    <main className="bg-[#0a0a0a]">
      ...
      <section className="relative min-h-screen flex items-end pb-20">
        ...
        <motion.span
          ...
          className="absolute top-20 left-0 text-[40vw] text-white leading-none pointer-events-none"
        ...
        <div className="relative z-10 px-6 md:px-12 lg:px-24 w-full">
          ...
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-block px-4 py-1 bg-rolling-red text-white text-xs tracking-wider uppercase mb-6">
              {service.tagline}
            </span>
            <h1 
              className="text-5xl md:text-7xl lg:text-8xl text-white leading-[0.9] mb-6"
      ...
      {/* Impact Stats */}
      <section className="py-16 px-6 md:px-12 lg:px-24 bg-rolling-red">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {caseStudyStats.map((stat, idx) => (
            ...
            >
              <span className="text-5xl text-white font-bold" style={{ fontFamily: 'var(--font-bebas)' }}>
                {stat.value}
              </span>
      ...
      <section ref={ref} className="py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              <span className="text-8xl text-rolling-red/20" style={{ fontFamily: 'Georgia, serif' }}>"</span>
              <p className="text-white text-2xl leading-relaxed -mt-12 pl-8">
          ...
          <motion.div
            ...
            className="relative h-[50vh] mb-24 overflow-hidden"
          >
            <Image
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <h3 className="text-6xl md:text-8xl text-white text-center" style={{ fontFamily: 'var(--font-bebas)' }}>
          ...
          >
            <div className="lg:col-span-2 p-12 bg-black border border-white/10">
              <h2 className="text-xl text-white mb-6 tracking-wider uppercase">Our Approach</h2>
              <p className="text-white/70 text-lg leading-relaxed">{service.fullContent.solution}</p>
            </div>
            <div className="p-12 bg-rolling-red/10 border border-rolling-red/30">
              <h2 className="text-xl text-rolling-red mb-6 tracking-wider uppercase">The Gap</h2>
              <p className="text-white/60 leading-relaxed">{service.fullContent.gap}</p>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white/50 max-w-2xl mx-auto">
              From intimate underground series to large-scale audiovisual experiences
            </p>
          </motion.div>
              ...
              {ipTypes.map((ip, idx) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <h3 className="text-xl text-white" style={{ fontFamily: 'var(--font-bebas)' }}>
                      {ip.title}
                    </h3>
                    <span className={`text-2xl ${activeIP === idx ? 'text-rolling-red' : 'text-white/30'}`}>
                      0{idx + 1}
                    </span>
                  </div>
                </motion.button>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {ipTypes[activeIP].features.map((feature, idx) => (
                    <span key={idx} className="px-3 py-1 text-xs text-rolling-red border border-rolling-red/30">
                      {feature}
                    </span>
                  ))}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {creationProcess.map((step, idx) => (
              ...
              >
                <span className="text-rolling-red text-xs tracking-[0.3em] block mb-4">{step.phase}</span>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {service.fullContent.deliverables.map((item, idx) => (
              <motion.div
                ...
                className={`p-6 border border-white/10 hover:border-rolling-red/50 transition-all ${idx % 3 === 0 ? 'md:col-span-2' : ''}`}
              >
                <span className="text-rolling-red text-xs">0{idx + 1}</span>
                <p className="text-white mt-2">{item}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className={`relative overflow-hidden group ${idx === 0 ? 'col-span-2 row-span-2' : 'aspect-square'}`}
                style={{ aspectRatio: idx === 0 ? '1/1' : undefined }}
              >
                <Image
                  src={img}
                  alt="Event aesthetic"
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 bg-black">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="max-w-4xl mx-auto text-center py-20 border-t border-b border-white/10"
        >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Link href="/services/strategic-partnerships" className="p-6 bg-black border border-white/10 hover:border-rolling-red/50 transition-all group">
              <span className="text-rolling-red text-sm tracking-wider">BRAND PARTNERSHIPS</span>
              <h3 className="text-xl text-white mt-2 group-hover:text-rolling-red transition-colors" style={{ fontFamily: 'var(--font-bebas)' }}>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Let's transform your vision into a cultural property that resonates across markets and builds lasting community.
          </p>
